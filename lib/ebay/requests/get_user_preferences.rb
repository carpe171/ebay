...
module Ebay # :nodoc:
  module Requests # :nodoc:
    # == Attributes
    #  boolean_node :show_bidder_notice_preferences, 'ShowBidderNoticePreferences', 'true', 'false', :optional => true
    #  boolean_node :show_combined_payment_preferences, 'ShowCombinedPaymentPreferences', 'true', 'false', :optional => true
    #  boolean_node :show_cross_promotion_preferences, 'ShowCrossPromotionPreferences', 'true', 'false', :optional => true
    #  boolean_node :show_seller_payment_preferences, 'ShowSellerPaymentPreferences', 'true', 'false', :optional => true
